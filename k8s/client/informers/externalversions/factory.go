...
import (
	...
	taskbenjaminborbede "github.com/bborbe/recurring-task-creator/k8s/client/informers/externalversions/task.benjamin-borbe.de"
...
func (f *sharedInformerFactory) Task() taskbenjaminborbede.Interface {
	return taskbenjaminborbede.New(f, f.namespace, f.tweakListOptions)
}
