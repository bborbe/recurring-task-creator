...
completed: "2026-09-08T11:02:57Z"
...
**Verified:** 2026-09-08T10:29:49Z (HEAD c2441ae = v0.12.0 code content)
**Binary:** installed dark-factory (spec not dark-factory itself); deployed recurring-task-creator v0.12.0 on dev + prod
**Scenario:** none — spec-declared (container-executable ACs + operator rungs)
**Evidence:**
- make precommit exit 0 (fresh warm-cache re-run; tree clean after)
- go test -count=1 ./pkg/... all ok; hourly always-fire, tick hour-threading, YYYYMMDDHH token + hour-12/13 distinctness, CEL accept/reject specs green
- greps: recurrence.go:28 RecurrenceHourly const; date.go:21 Hour int (hourly-only GoDoc); k8s_connector_schema.go:29 "Hourly"; period_token.go removed non-comment lines = 0
- dev pod log (v0.12.0, pod restarted 09:21:33Z): sent CreateCommand slug="hourly-probe-017" @ 09:21:38Z and 10:17:17Z
- prod pod log (v0.12.0, pod restarted 09:21:53Z): sent CreateCommand slug="hourly-probe-017" @ 09:21:57Z and 10:17:25Z
- vault git OctopusAgent: create tasks/Hourly Probe 017 - 2026090811.md (fc3f5360e, 09:21:38Z) and - 2026090800.md (4fed5a853, 10:17:18Z); 0 probe files remain
- CRD dev+prod recurrence enum includes "Hourly"; periodOffset CEL rule excludes Hourly
**Verdict:** PASS
