...
- [Development Guide](obsidian://open?vault=Personal&file=50%20Knowledge%20Base%2FDevelopment%20Guide)
- Parent task: [Migrate recurring Jira subtasks to vault task system](obsidian://open?vault=Personal&file=24%20Tasks%2FMigrate%20recurring%20Jira%20subtasks%20to%20vault%20task%20system)
- Predecessor: `jira-task-creator` (`~/Documents/workspaces/jira-task-creator/`)
